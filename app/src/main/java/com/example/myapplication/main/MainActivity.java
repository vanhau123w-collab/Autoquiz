...
import com.example.myapplication.main.fragments.CreateFragment;
import com.example.myapplication.main.fragments.HomeFragment;
import com.example.myapplication.main.fragments.LibraryFragment;
import com.example.myapplication.main.fragments.SettingsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check for language switching flag BEFORE super.onCreate if possible, 
        // but here we need it after super.onCreate to update fragment state.
        ...
        boolean isSwitching = sharedPref.getBoolean("is_switching_language", false);
        if (isSwitching) {
            // Reset flag and go to Settings tab
            sharedPref.edit().putBoolean("is_switching_language", false).apply();
            switchToTab(3);
